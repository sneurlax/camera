...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if(WIN32)
        # Resolve symlinks in CMAKE_CURRENT_SOURCE_DIR first; on Windows ".."
        # traversal does not cross symlink targets so the relative manifest_dir
        # path would land in the wrong place.
        execute_process(COMMAND powershell -ExecutionPolicy Bypass -File "${cargokit_cmake_root}/cmake/resolve_symlinks.ps1" "${CMAKE_CURRENT_SOURCE_DIR}" OUTPUT_VARIABLE _resolved_src OUTPUT_STRIP_TRAILING_WHITESPACE)
        set(_manifest_dir "${_resolved_src}/${manifest_dir}")
    else()
